...
LOG_NEW_SERVICE="/usr/share/security-config/log/New_Service.txt"
LOG_DELETED_DERVICE="/usr/share/security-config/log/Deleted_Service.txt"
RESULT_NEW_SERVICE="/usr/share/security-config/result/New_Service.txt"
RESULT_DELETED_DERVICE="/usr/share/security-config/result/Deleted_Service.txt"
