...
outputfile='/usr/share/security-config/output/smack_rule_test/checksmackrule_saved.csv'
...
/bin/echo "Wrong Smack Rule Lists" > $outputfile

RULE_CHECK_APPLY_PATH

/bin/echo "Generated checksmackrule_saved.csv / SMACK RULE CHECK FINISHED! "
